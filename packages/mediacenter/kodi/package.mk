...
case $KODI_VENDOR in
  amlogic-4.9)
    PKG_VERSION="ef3b1dacba6240698ba2cebe93d20a28a2d3250c"
    PKG_SHA256="c2a6a0b66db428775b92eca186f7975ee7bc882d1618d1388db933d62d9ae33a"
...
configure_package() {
  ...
  if [ "$DEVICE" = "Amlogic" -o "$DEVICE" = "Amlogic-ng" ]; then
